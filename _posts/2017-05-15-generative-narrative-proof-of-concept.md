...
### Answers
  - A narrative should contain sequence, and cause-effect relationships.
  - Subjects, characters, nouns.
  - Should be placed in time or have a sense of time?
  - Work generated by a model that is trained on just one author's body of work leans too closely to that singular author; work generated by a model that is trained on text from multiple authors begins to enter a more interesting realm of autonomous creation(?)  
...
If not in real-time, the project would likely be either documentation of interactions between multiple neural networks or the result of machine generation – which may or may not be edited/curated/interpreted by human creators.

### Real-Time Proposals:  
  - Object Recognition Based Storytelling  
  - Voice Responsive Storytelling

### Pre-rendered Proposals:  
