...
![RNN](/docs/_assets/images/rnn.png)

RNN (Recurrent Neural Network)

![LSTM](/docs/_assets/images/lstm.png)

LSTM (Long / Short Term Memory)

![GRU](/docs/_assets/images/gru.png)
...
![RNNgenerate](/docs/_assets/images/01-house_generate.gif)
![RNNread](/docs/_assets/images/01-house_read.gif)
